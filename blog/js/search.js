    ...
    $.ajax({
        ...
        success: function (xmlResponse) {
            ...
            $input.addEventListener('input', function () {
                ...
                var keywords = this.value.trim().toLowerCase().split(/blog/[\s\-]+/);
                ...
                datas.forEach(function (data) {
                    ...
                    var data_content = data.content.trim().replace(/blog/<[^>]+>/g, "").toLowerCase();
                    ...
                    if (isMatch) {
                        ...
                        var content = data.content.trim().replace(/blog/<[^>]+>/g, "");
                        if (first_occur >= 0) {
